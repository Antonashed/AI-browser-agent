...
- [x] Добавить caching → тесты проходят
...
- [x] Добавить сжатие → тесты проходят
...
- [x] Описание, установка, использование
